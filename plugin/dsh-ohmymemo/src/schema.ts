...
const CONFIG_FIELDS = {
  ...
  capsule_top_entries: (v: unknown): v is number => Number.isInteger(v) && (v as number) >= 1 && (v as number) <= 20,
  index_entry_summary_chars: (v: unknown): v is number => Number.isInteger(v) && (v as number) >= 40 && (v as number) <= 400,
  index_max_entries: (v: unknown): v is number => Number.isInteger(v) && (v as number) >= 10 && (v as number) <= 2000,
