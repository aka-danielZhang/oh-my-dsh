  ...
  descriptors: [
    {
      ...
      sourceLocation: { file: 'src/manager.ts', line: 193, column: 3 },
    },
    {
      ...
      result: { mode: 'strict', typeSymbol: 'dsh-ohmymemo/manager-contract#MemoryOverview', schema: memoryOverviewSchema },
      sourceLocation: { file: 'src/manager.ts', line: 226, column: 3 },
    },
    {
    ...
    },
    {
      ...
      sourceLocation: { file: 'src/manager.ts', line: 280, column: 3 },
    },
    {
      ...
      sourceLocation: { file: 'src/manager.ts', line: 285, column: 3 },
    },
    {
      ...
      sourceLocation: { file: 'src/manager.ts', line: 293, column: 3 },
    },
    {
      ...
      sourceLocation: { file: 'src/manager.ts', line: 307, column: 3 },
    },
  ],
}
