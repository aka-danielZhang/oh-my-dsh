/**
 * Build config for dsh-settings-icons, distilled from the harness's
...
export default defineConfig([
  ...
  {
    name: 'dsh-settings-icons/client',
    ...
    outputOptions: {
      ...
      banner: 'window.__ModuleLoader__.load({ id: "dsh-settings-icons", factory: (require) => {',
